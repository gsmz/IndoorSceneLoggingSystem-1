...
namespace
{
	...
	client::SocketType socket_type_kinectv2_client = ZMQ_REQ;
}
namespace client
{
	namespace sensor_client
	{
		KinectV2Client::KinectV2Client() : Client::Client( client_name_kinectv2_client, socket_type_kinectv2_client, num_threads_kinectv2_client )
		{
